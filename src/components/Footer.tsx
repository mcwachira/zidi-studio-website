...
const Footer = () => {
    return (
        <>
            <footer className="relative ml-8 z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
                <div className="container">
                  ...
                  {/*</span>*/}
                        ...
                        <LinkGroup header="Quick Links">
                            ...
                            <NavLink link="/conmtact" label="Contact Us" />
                    ...
                    <div className="my-10 text-base text-center text-gray-600 dark:text-gray-400">
                        Copyright © {new Date().getFullYear()}. Made with ♥ by{" "}
                        <a
                            href="https://www.mcwachira.com/"
                            target="_blank"
                            rel="noopener">
                            @mcwachira.
                        </a>{" "}
